...
import 'package:saja_stor_app/view/detail_page.dart';
...
class HomePage extends StatelessWidget {
          ...
          GestureDetector(
            onTap: () async {
              ...
              controller.fetchSugection(
                  suggestionId: item.suggestions, it: controller.items);
              Navigator.push(
                context,
                MaterialPageRoute(
  ...
  Padding searchField(HomeController controller) {
    return Padding(
